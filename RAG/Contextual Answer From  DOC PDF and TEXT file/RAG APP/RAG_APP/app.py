...
# Example usage
prompt_template = (
    "You are an assistant for finding the the answer to questions using the provided context. "
    "If the question is not related to the provided context, please specify that [provide further details or related references for your question. "
